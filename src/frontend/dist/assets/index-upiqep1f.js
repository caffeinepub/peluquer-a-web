...
function App() {
  const [reservas, setReservas] = reactExports.useState(loadReservas);
  ...
  const [mensajeWA, setMensajeWA] = reactExports.useState(DEFAULT_MENSAJE);
  const [exito, setExito] = reactExports.useState(false);
  reactExports.useEffect(() => {
    saveReservas(reservas);
  }, [reservas]);
  const total = seleccionados.reduce((acc, s) => {
    const srv = SERVICIOS.find((x2) => x2.id === s);
  ...
  function handleReservar(e) {
    ...
    if (seleccionados.length === 0) {
      ue.error("Selecciona al menos un servicio.");
      return;
    }
    const nueva = {
    ...
    setExito(true);
    ue.success(`¡Reserva creada para ${nombre}!`);
    resetForm();
    setTimeout(() => setExito(false), 4e3);
  }
  function confirmarReserva(id) {
    const r2 = reservas.find((x2) => x2.id === id);
    setReservas(
      (prev) => prev.map(
        (item) => item.id === id ? { ...item, estado: "confirmada" } : item
      )
    );
    if (r2) {
      const msg = r2.mensajeWhatsApp.replace(/\{nombre\}/g, r2.nombre).replace(/\{fecha\}/g, r2.fecha).replace(/\{hora\}/g, r2.hora);
      const url = `https://wa.me/${r2.telefono.replace(/\D/g, "")}?text=${encodeURIComponent(msg)}`;
      window.open(url, "_blank");
      ue.success(`Reserva de ${r2.nombre} confirmada. Abriendo WhatsApp…`);
    }
  }
  function cancelarReserva(id) {
    setReservas(
      (prev) => prev.map(
        (item) => item.id === id ? { ...item, estado: "cancelada" } : item
      )
    );
    ue.error("Reserva cancelada.");
  }
  function estadoBadge(estado) {
    if (estado === "confirmada")
      return /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "bg-green-700 text-white hover:bg-green-700", children: "Confirmada" });
    if (estado === "cancelada")
      return /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "destructive", children: "Cancelada" });
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "bg-yellow-600 text-white hover:bg-yellow-600", children: "Pendiente" });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background text-foreground flex flex-col", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "border-b border-border bg-card/80 sticky top-0 z-10 backdrop-blur", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto px-4 py-4 flex items-center gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-full bg-primary/20 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Scissors, { className: "w-5 h-5 text-primary" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-xl font-semibold text-primary leading-none", children: "Peluquería" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Sistema de Reservas" })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1 max-w-4xl mx-auto w-full px-4 py-8 space-y-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CalendarCheck, { className: "w-5 h-5 text-primary" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-semibold", children: "Nueva Reserva" })
        ] }),
        exito && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-4 rounded-lg bg-green-900/30 border border-green-700 text-green-300 px-4 py-3 text-sm", children: "✅ ¡Reserva registrada con éxito! Aparece en la tabla a continuación." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border-border bg-card", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "form",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "nombre", children: "Nombre completo" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Input,
                  {
                    id: "nombre",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "telefono", children: "Teléfono (con código de país)" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Input,
                  {
                    id: "telefono",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Sin espacios ni guiones. Se usará para WhatsApp." })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Servicios" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-3", children: SERVICIOS.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    className: `flex items-center gap-3 rounded-lg border p-3 transition-colors ${seleccionados.includes(s.id) ? "border-primary bg-primary/10" : "border-border bg-background"}`,
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        Checkbox,
                        {
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        Label,
                        {
                          ...
                          children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium block", children: s.label }),
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-primary font-semibold block", children: [
                              "$",
                              s.precio
                            ] })
                          ]
                ...
                seleccionados.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm font-semibold text-primary", children: [
                  "Total: $",
                  total
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "fecha", children: "Fecha" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Input,
                    {
                      id: "fecha",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "hora", children: "Hora" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Input,
                    {
                      id: "hora",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
                  "Variables:",
                  " ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("code", { className: "text-primary", children: "{nombre}" }),
                  ",",
                  " ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("code", { className: "text-primary", children: "{fecha}" }),
                  ",",
                  " ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("code", { className: "text-primary", children: "{hora}" })
                ] })
              ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CalendarCheck, { className: "w-5 h-5 text-primary" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-semibold", children: "Reservas registradas" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "ml-auto", children: reservas.length })
        ] }),
        reservas.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Scissors, { className: "w-10 h-10 mx-auto mb-3 opacity-30" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", children: "¡Aún no hay reservas. Crea la primera!" })
            ]
          }
        ) : /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { className: "bg-card hover:bg-card", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { children: "Servicios" }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: reservas.map((r2, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { "data-ocid": `reservas.item.${i + 1}`, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "font-medium whitespace-nowrap", children: r2.nombre }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "whitespace-nowrap text-muted-foreground", children: r2.telefono }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "whitespace-nowrap", children: r2.fecha }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "whitespace-nowrap", children: r2.hora }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "whitespace-nowrap text-sm", children: r2.servicios.join(", ") }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(TableCell, { className: "whitespace-nowrap font-semibold text-primary", children: [
                  "$",
                  r2.total
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: estadoBadge(r2.estado) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-right", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-end gap-2", children: [
                  r2.estado !== "confirmada" && r2.estado !== "cancelada" && /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Button,
                    {
                      size: "sm",
                      "data-ocid": `reservas.confirm_button.${i + 1}`,
                      className: "bg-green-700 hover:bg-green-600 text-white h-8 px-3 text-xs",
                      onClick: () => confirmarReserva(r2.id),
                      children: "Confirmar"
                    }
                  ),
                  r2.estado !== "cancelada" && /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Button,
                    {
                      size: "sm",
                      variant: "destructive",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "border-t border-border mt-12 py-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-center text-xs text-muted-foreground", children: [
      "© ",
...
Service({
  "getReservations": Func([], [Vec(Reservation)], ["query"]),
  "submitReservation": Func([Reservation], [], [])
});
